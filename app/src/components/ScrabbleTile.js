...
export default function ScrabbleTile({ value, score, setCurrentTile, extraClasses }) {

    return (
        <>
            {value && score ? (
                <div className={`tile btn btn-secondary d-inline-flex m-1 ${extraClasses}`} onClick={setCurrentTile}>
