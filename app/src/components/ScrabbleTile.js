...
export default function ScrabbleTile({ value, score, setCurrentTile, classNameForSelecting }) {

    return (
        <>
            {value && score ? (
                <div className={`tile btn btn-secondary d-inline-flex m-1 ${classNameForSelecting}`} onClick={setCurrentTile}>
